...
namespace crystal {
    ...
    /**
     * @brief Retrieves an optimal configuration 
     *        for the kernel according to the device
     * 
     * @param q sycl::queue
     * @param job_size the size of the job in terms of blocks
     * @return a kernel_config "object"
     */
